...
pub enum Error {
    ...
    ProceedRound(crate::presigning::rounds::Error),
...
pub enum SignError {
    ...
    LocalSigning(crate::presigning::rounds::Error),
    #[error("couldn't complete signing: {0}")]
    CompleteSigning(crate::presigning::rounds::Error),
}
...
mod test {
    ...
    use super::*;
    use crate::common::party_i::verify;
    use crate::dkg::keygen::test::simulate_keygen;
